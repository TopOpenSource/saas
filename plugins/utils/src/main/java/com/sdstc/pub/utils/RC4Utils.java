...
//		try {
//			String pwd = PasswordUtils.genRandomPwd(16);
//			System.out.println("初始字符串："+pwd);
//			String encryStr = RC4Utils.encryRC4String(pwd, "123456","UTF-8");
//			System.out.println("加密后得到得字符串："+encryStr);
//			String decryStr = RC4Utils.decryRC4(encryStr, "123456", "UTF-8");
